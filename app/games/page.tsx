  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-100 to-indigo-100">
            ...
            >
              <Link href={`/games/${game.id}`}>
                ...
                >
                  ...
                  <p className="text-white/90 font-semibold text-lg mb-6">{game.description}</p>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t-2 border-green-200 flex justify-around items-center py-2 px-4 z-20">
        ...
        <Link href="/games" className="flex flex-col items-center gap-1 text-purple-600">
          <span className="text-2xl">🎮</span>
          <span className="text-xs font-bold">Games</span>
        </Link>
        <Link href="/progress" className="flex flex-col items-center gap-1 text-gray-500 hover:text-yellow-600">
          <span className="text-2xl">⭐</span>
